...
// 相対パスを使用してプロジェクトルートのnode_modulesからインポート
import { Server } from '../node_modules/@modelcontextprotocol/sdk/server/index.js';
import { StdioServerTransport } from '../node_modules/@modelcontextprotocol/sdk/server/stdio.js';
import { ListResourcesRequestSchema, ReadResourceRequestSchema, ListPromptsRequestSchema, ListToolsRequestSchema, CallToolRequestSchema } from '../node_modules/@modelcontextprotocol/sdk/types.js';
import { z } from 'zod';
import fs from 'fs';
